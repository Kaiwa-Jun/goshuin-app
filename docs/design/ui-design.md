...
都道府県のタイルマップが両方を兼ねる。要件は `docs/design/2026-09-ayumi-map-spec.md`、
デザインの正は `docs/design/mockups/2026-09-ayumi-map-v2.html`。

**表示セクション**:

1. **都道府県タイルマップ**: 47県を正方形のマスで並べ、**御朱印の枚数**で3段に濃くする。
   いちばん新しい県だけ朱 + リング。上部に「12 / 47 都道府県」と通算の枚数。
   マスをタップするとその県の御朱印一覧がシートで出る
