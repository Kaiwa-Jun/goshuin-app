...
>
> - **タブ構成**: 本書の「地図 / ギャラリー / コレクション / 設定」は 2026-08-09 に **「地図 / 御朱印帳 / あつめる / 自分」** へ変更（Issue #123・案3。決定の経緯は `docs/design/mockups/ia-options.html`）、さらに 2026-09-19 に **「地図 / 御朱印帳 / あゆみ / 設定」** へ変更済み（Issue #153）。行きたいリストはコレクションから地図タブへ移した
...
3. **シンプルなタブナビゲーション**: 地図・御朱印帳・あゆみ・設定の4タブ（2026-08-09 に案3へ変更、2026-09-19 に #153 で あゆみ / 設定 へ改名）
