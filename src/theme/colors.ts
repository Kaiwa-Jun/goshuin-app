export const colors = {
   ...
   */
  seal: '#C2342B',
  /** 和紙の地。オンボーディングの御朱印・御朱印帳の写真の読み込み中の下地・年報 */
  washi: '#EFEAE0',
  /** 和紙の下地の内側に引く薄い枠（Issue #275） */
  washiFrame: 'rgba(0, 0, 0, 0.06)',
  /**
   * 御朱印帳の写真の読み込み中に、下地の真ん中でめくれ続ける小さな御朱印帳（Issue #275）。
   * 値は試作 docs/design/mockups/2026-09-gallery-loading-v2.html のまま。
   * 表紙の上端は primary[700]、印は seal を使い回す
   */
  loadingBook: {
    /** 表紙の下端。上端の primary[700] から、少し沈んだ朱へ */
    coverEnd: '#A83A0E',
    /** 見開きとめくれる紙。splash（#F7F3EA）より白い */
    paper: '#FBF8F1',
    /** 紙の厚みの縞の線 */
    paperEdge: '#EDE6D8',
    /** 本が地に落とす影 */
    ...
    /**
     * 綴じ目の陰の透明な側。透明な黒ではなく同じ茶色の透明にする
     * （iOS のグラデーションは透明な黒から色へ向かうと途中が灰色に濁る）
     */
